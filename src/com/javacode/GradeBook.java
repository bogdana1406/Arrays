...
public class GradeBook {
    public static void main(String[] args) {
        ...
        System.out.println("Minimal grades "+calcMin(gradesArray));
    ...
    private static void varArgs() {
        ...
        System.out.println("Average of 2 elements "+calcAverage(a, b));
        System.out.println("Average of 3 elements "+calcAverage(a, b, c));
        System.out.println("Average of 4 elements "+calcAverage(a, b, c, d));
    ...
    private static void processArrays() {
        ...
        int[] fieldArray = new int[7];
        Arrays.fill(fieldArray, 8);
